# Conducteur d'animation — Testing Event, 14 septembre 2026

Business Center Crédit Agricole Assurances, 36/44 bd de Vaugirard, Paris.
Matinée en auditorium, après-midi en 10 kiosques sur 5 rotations.

**Ce document est le conducteur de régie et d'organisation.** Il n'est pas fait
pour être tenu en main sur scène : chaque animateur doit en tirer une antisèche
recto d'une page (voir « Ce qu'il reste à produire », en fin de document).

Tous les horaires ci-dessous sont repris de la page programme
(`worker/public/testing-event-2026/index.html`), seule source de vérité. Si un
horaire change ici, il doit changer là-bas, et inversement.
...
| Rôle | Qui | Présent de → à |
|---|---|---|
| Ouverture & clôture | Ghislaine | 09h40 → 09h56 · 16h25 → fin |
...
## 2. Chronologie de référence

| Heure | Séquence | Durée | Animation |
|---|---|---|---|
| 09h00 | Accueil café & petit-déjeuner | 45 min | — |
| 09h41 | Musique d'accueil | 4 min | régie |
...
| 15h30 | Rotation 4 | 30 min | kiosques |
| 16h00 | Rotation 5 | 30 min | kiosques |
| 16h30 | Mot de clôture & remise des lots | 30 min | Ghislaine + Anas + Fabrice |

Chaque rotation de 30 min contient **20 min d'atelier + 5 min de questions**.
Les 5 dernières minutes sont le budget de déplacement d'une salle à l'autre.
Ce n'est pas du temps libre : c'est ce qui permet à la rotation suivante de
démarrer à l'heure.
...
### 3.1 — 09h41 · Musique d'accueil

**Régie.** Musique lancée à 09h41, volume salle. Fondu de sortie amorcé quand
Ghislaine s'avance, pas avant : c'est elle qui déclenche, pas la pendule.
Slide 1 (page de garde animée) à l'écran depuis 09h00.

**Rôle de la musique** : faire comprendre sans le dire que ça va commencer. Ne
pas la doubler d'une annonce micro « veuillez rejoindre vos places », qui
produit l'effet inverse.

---

### 3.2 — 09h45 · Mot d'ouverture (15 min)

Séquencement serré. C'est le créneau le plus exposé de la matinée : quatre
prises de parole en quinze minutes, et un dépassement ici décale la conférence 1.

| Sous-séquence | Qui | Fin visée |
|---|---|---|
| Accueil, cadre de la journée, annonce du sponsor | Ghislaine | 09h49 |
| Mot du sponsor | Fabrice | 09h53 |
| Programme de la journée | Ghislaine | 09h56 |
| Passage de relais, QR code, annonce conf. 1 | Anas | 10h00 |

#### Ghislaine — accueil (≈ 4 min)

Messages à passer, dans cet ordre :

1. **Bienvenue et ce que c'est.** Le Testing Event, sa raison d'être, pourquoi
   Crédit Agricole Assurances y consacre une journée entière.
2. **La journée est une journée, pas une matinée.** Le dire dès la première
   minute : conférences le matin, **10 kiosques en simultané l'après-midi**,
   clôture à 16h30. Une partie de la salle repartira après le cocktail si
   personne ne lui a dit qu'il se passe quelque chose ensuite.
3. **Annonce du sponsor** et passage de parole à Fabrice.

À ne pas faire ici : dérouler le programme heure par heure. C'est la séquence
suivante, et le refaire deux fois coûte trois minutes qu'on n'a pas.

#### Fabrice — mot du sponsor (≈ 4 min)

`[ à compléter : angle retenu avec Fabrice ]`

> **Le risque de dérapage numéro un de la matinée est ici.** Quatre minutes
> annoncées deviennent huit si personne n'a calé la durée en amont. À faire
> avant le jour J : lui donner la durée en minutes, pas « quelques mots », et
> convenir d'un signe discret de Ghislaine restée en bord de scène.

#### Ghislaine — programme de la journée (≈ 3 min)

Slide « Programme de la journée » à l'écran.

1. Matin : deux conférences et une table ronde, questions après chacune.
2. Cocktail déjeunatoire à 12h15.
3. **Reprise à 13h40** pour l'organisation de l'après-midi.
4. Après-midi : 10 kiosques, 5 rotations identiques, chacun choisit ses
   sessions — on ne subit pas un parcours imposé.
5. Clôture à 16h30, **avec remise de lots**.

#### Anas — relais et QR code (≈ 4 min)

Slide QR code à l'écran, plein cadre, et **laissé affiché pendant qu'il parle**.

1. Il se présente et annonce qu'il accompagne la journée jusqu'à la clôture.
2. **Le QR code.** Message à passer : *« tout le programme est là, et il vit
   pendant la journée »* — le détail des 10 kiosques, leur pitch, et surtout
   **le numéro de salle de chacun**, mis à jour le matin même. C'est la seule
...
### 3.3 — 10h00 · Conférence 1 (45 min)

> **Les 45 minutes ne sont pas 45 minutes de conférence.** Elles contiennent le
> générique, la montée sur scène, la conférence, les questions et l'annonce de
> la suite. Le budget réel :

| | Durée | Fin visée |
|---|---|---|
| Générique | 15 s | 10h00 |
| Conférence | ≤ 32 min | 10h33 |
...
Message d'ouverture d'Anas, court : *« On a une dizaine de minutes de
questions. Levez la main, un micro vient à vous — et attendez le micro, sinon
la salle ne vous entend pas. »*
...
- **Anas doit arriver avec deux questions écrites par conférence**, préparées à
  ...
  *« Je commence, ça vous laissera le temps de formuler les vôtres. »* Le silence
  après « des questions ? » est le point de rupture classique de ce format, et
  il ne se rattrape pas en improvisation.
- **Il reformule chaque question au micro** avant que l'intervenant réponde.
  Pour la salle, pour l'intervenant, et pour se donner deux secondes.
- À 10h40, il annonce **la dernière question**. Ça évite de couper quelqu'un.
...
### 3.4 — 10h45 · Conférence 2 (45 min)

Même structure, même budget :

| | Durée | Fin visée |
|---|---|---|
| Générique | 15 s | 10h45 |
| Conférence | ≤ 32 min | 11h18 |
...
**Une chose à surveiller ici.** Le sujet est celui qui va faire lever le plus de
mains, et quatre des dix kiosques de l'après-midi portent sur l'IA (LynQA,
écosystème d'agents, Yest Companion, SDSI Test & IA). Anas a donc une réponse
toute prête pour les questions trop pointues : *« ça, c'est exactement le sujet
du kiosque n° X cet après-midi — allez-y avec cette question. »* Ça tient le
temps et ça remplit les kiosques.
...
### 3.5 — 11h30 · Table ronde (45 min)

| | Durée | Fin visée |
|---|---|---|
| Générique | 15 s | 11h30 |
| Table ronde | ≤ 32 min | 12h03 |
| Questions | 7 min | 12h10 |
| Cocktail + message de rétention | 5 min | 12h15 |
...
### 3.6 — 12h10 · Le message le plus important de la matinée

> **C'est ici que la salle décide de rester ou de partir**, pas à 13h40. À 13h40
> Anas ne parlera qu'à ceux qui sont déjà restés. Cinq minutes, pleines.

Anas, dans cet ordre :

1. **Le cocktail est ouvert**, où il se tient, jusqu'à quand.
2. **On se retrouve à 13h40** dans cet auditorium. Donner l'heure deux fois.
3. **Ce qui se passe l'après-midi** : 10 kiosques en simultané, 5 rotations
   identiques de 30 minutes, chacun construit son propre parcours. Pas de
...
5. **La règle qui remplit la salle à 16h30** :
   ...
   c'est décidé mais annoncé seulement à 16h30, c'est perçu comme injuste.
6. **Le QR code, à nouveau.** *« Les numéros de salle des dix kiosques sont
   dessus. Regardez pendant le cocktail et repérez vos cinq. »* Le cocktail est
   le seul moment de la journée où les gens ont le temps de le faire.

---

## 4. Après-midi

### 4.1 — 13h36 · Musique de reprise

Même dispositif qu'à 09h41. Slide 1 à l'écran.

Les gens reviennent du cocktail en ordre dispersé : le fondu de sortie se fait
au signal des animateurs, pas à 13h40 pile.
...
1. **10 kiosques tournent en même temps, 5 fois.** Les cinq rotations sont
   **identiques** : rater un kiosque à 14h00 ne veut pas dire l'avoir raté.
2. **Chaque rotation dure 30 minutes : 20 minutes d'atelier, 5 minutes de
   questions, 5 minutes pour se déplacer.** Le déplacement fait partie du
   créneau — c'est pour ça qu'il faut partir quand l'atelier se termine.
3. **On choisit ses cinq kiosques.** Les numéros de salle sont sur le QR code
   et sur les affiches A3 posées sur les portes.
4. **Horaires** : 14h00, 14h30, 15h00, 15h30, 16h00.

#### Tirage au sort et lots (3 min)

Le mécanisme, dit lentement, dans cet ordre :

1. **À chaque kiosque, vous remplissez une fiche** : nom, prénom, numéro du
   kiosque.
...
#### Rappel et dispersion (2 min)

1. Le QR code encore une fois, à l'écran : *« vos salles sont là-dessus. »*
2. **« On se retrouve ici à 16h30 pour la clôture et la remise des lots. »**
3. Bonne après-midi, et on libère la salle.

---

### 4.3 — 14h00 → 16h30 · Les cinq rotations
...
doivent le savoir : **ils doivent conclure à 16h25, pas à 16h30.** Les salles
Sumida, Alzette et Garonne sont les plus éloignées ; leurs participants
arriveront les derniers.

---

## 5. Clôture — 16h30 (30 min)

> **Ne pas commencer à parler à 16h30 pile.** La salle se remplit entre 16h28 et
> 16h35 depuis dix salles réparties sur l'étage. Prévoir de prendre la parole
> vers **16h33**, avec la musique en fond jusque-là. Commencer devant une salle
> à moitié vide gâche la séquence la plus mémorable de la journée.

### Ordre proposé — et pourquoi il diffère de l'ordre initial

L'ordre initialement décrit était : mot de clôture → Fabrice → remise des lots →
remerciements → musique.

**Problème : le tirage au sort est la seule chose qui retient les gens assis.**
Une fois les trois lots remis, une partie de la salle se lève. Les trois groupes
remerciés monteraient alors sur scène devant des fauteuils qui se vident — pour
des gens venus de l'extérieur et pour le staff, c'est le pire moment possible.

**Ordre proposé :**

| Sous-séquence | Qui | Durée | Fin visée |
|---|---|---|---|
| Mot de clôture | Ghislaine + Anas | 3 min | 16h36 |
| Remerciements, montée sur scène | Anas | 8 min | 16h44 |
| Conclusion du sponsor | Fabrice | 4 min | 16h48 |
...
Trois groupes, appelés **par groupe et non nom par nom**, dans cet ordre :

1. **Les intervenants extérieurs du matin** — conférenciers et participants à la
   table ronde. `[ à compléter : sociétés et noms ]`
2. **Les porteurs des dix kiosques.** `[ à compléter ]`
3. **Le staff de l'organisation.** `[ à compléter ]`

> **La logistique de cette séquence est ce qui la fait dérailler.** Huit minutes
> pour trois montées sur scène, c'est jouable uniquement si :
> - chaque groupe est **prévenu la veille** et **déjà debout côté scène** avant
>   16h30 — pas cherché dans la salle au moment de l'appel ;
> - on **nomme les gens une fois qu'ils sont sur scène**, pas pendant qu'ils
>   traversent la travée ;
> - il y a **une photo par groupe**, pas une par personne ;
> - **chaque groupe reste sur scène** une fois monté. Cela évite trois
>   allers-retours et cela remplit le plateau pour le tirage qui suit.
>
> Appelés un par un depuis leur siège, trente personnes prennent quinze minutes.

### 5.3 — Conclusion du sponsor (4 min)

Fabrice. `[ à compléter : angle retenu ]` Même remarque qu'au matin sur la durée
calée à l'avance.

### 5.4 — Tirage au sort et remise des lots (8 min)
...
4. `[ à compléter : lot 1 / lot 2 / lot 3 ]`
5. **Prévoir le cas du gagnant absent.** La règle doit être annoncée avant le
   premier tirage, pas inventée devant l'urne.

### 5.5 — Musique de fin

Lancée sur la dernière phrase d'Anas, pendant que la scène est encore pleine.
Dernier message : merci aux participants, et le QR code reste accessible après
la journée `[ à confirmer : jusqu'à quand la page reste-t-elle en ligne ? ]`.
...
| # | Heure | Cue | Sortie |
|---|---|---|---|
| 1 | 09h00 | Slide 1 (page de garde animée) à l'écran | — |
| 2 | 09h41 | Musique d'accueil | fondu au signal de Ghislaine |
| 3 | 09h53 | Slide « Programme de la journée » | — |
| 4 | 09h56 | Slide QR code, plein cadre | maintenue 3 min |
| 5 | 10h00 | **Générique 15 s** — conférence 1 | au top d'Anas |
...
- retour vidéo visible depuis la scène, sinon les animateurs parlent dos à
  l'écran sans savoir ce qui est affiché.
